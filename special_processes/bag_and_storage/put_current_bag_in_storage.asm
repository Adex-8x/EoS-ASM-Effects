; ------------------------------------------------------------------------------
; Put Current Bag in Storage
; Puts all current bag items to the current Kangaskhan Storage! This does not clear the bag, so please see Irdkwia's process if you want to do so!
; No parameters.
