; ------------------------------------------------------------------------------
; Add or Sub Monster Entry Level
; Performs addition or subtraction to a Chimecho Assembly member's Level! Slot 0 is the player, 1 is the partner, and 5+ are recruitables.
