; ------------------------------------------------------------------------------
; Add or Sub Monster Entry Attack
; Performs addition or subtraction to a Chimecho Assembly member's Attack stat! Slot 0 is the player, 1 is the partner, and 5+ are recruitables.
