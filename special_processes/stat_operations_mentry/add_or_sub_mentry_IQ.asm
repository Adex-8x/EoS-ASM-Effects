; ------------------------------------------------------------------------------
; Add or Sub Monster Entry IQ
; Performs addition or subtraction to a Chimecho Assembly member's IQ! Slot 0 is the player, 1 is the partner, and 5+ are recruitables.
