; ------------------------------------------------------------------------------
; Add or Sub Monster Entry Defense
; Performs addition or subtraction to a Chimecho Assembly member's Defense stat! Slot 0 is the player, 1 is the partner, and 5+ are recruitables.
