; ------------------------------------------------------------------------------
; Set Monster Entry Move 2 Ginseng Boost
; Sets a Chimecho Assembly member's Ginseng boost of the second move! Slot 0 is the player, 1 is the partner, and 5+ are recruitables.
