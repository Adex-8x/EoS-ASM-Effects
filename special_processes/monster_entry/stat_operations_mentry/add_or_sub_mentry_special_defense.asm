; ------------------------------------------------------------------------------
; Add or Sub Monster Entry Special Defense
; Performs addition or subtraction to a Chimecho Assembly member's Special Defense stat! Slot 0 is the player, 1 is the partner, and 5+ are recruitables.
